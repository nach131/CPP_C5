...
/*   Updated: 2024/01/24 09:51:45 by nmota-bu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	}
	{
		...
		try
		{
			Form *myForm = new Form("DynamicForm", 90);

			std::cout << "Dynamic Form - Name: " << myForm->getName() << ", Grade: " << myForm->getGrade() << std::endl;

			myForm->up(5);
			std::cout << "After raising the grade: " << myForm->getGrade() << std::endl;

			Form anotherForm("AnotherForm", 80);
			*myForm = anotherForm;
			std::cout << "After assignment - Name: " << myForm->getName() << ", Grade: " << myForm->getGrade() << std::endl;
